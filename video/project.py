...
class Project(Scene):
    def construct(self):
        ...
        title = Text("CSE2021 DRTS Project Review",weight=BOLD)
        subtitle = Text("Siddharth Suresh 20BPS1042",weight=BOLD,font_size=25).move_to(DOWN)
        ...
        fastifytext = Text("Using FastifyJs & NodeJs",font_size=25,weight=BOLD).move_to(RIGHT*4.5+UP*3)
